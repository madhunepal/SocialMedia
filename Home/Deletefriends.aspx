<%@ Page Language="C#" MasterPageFile="~/Home/Home.master" AutoEventWireup="true" CodeFile="Deletefriends.aspx.cs" Inherits="Home_Deletefriends" Title="Delete Friends" %>
    ...
    <table style="width: 100%">
        <tr>
            <td style="width: 100%; height: 21px">
                ...
                &nbsp;<b><span 
                        style="font-size: x-large; font-family: Verdana; text-decoration: underline">Delete 
                    Friends</span></b></div>
