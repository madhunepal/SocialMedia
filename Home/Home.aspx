<%@ Page Language="C#" MasterPageFile="~/Home/Home.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Home_Home" Title="Homepage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 100%">
        ...
        <tr>
            <td style="vertical-align: middle; width: 100%; height: 21px; text-align: center">
                <span style="color: #663333; font-family: Verdana; font-size: medium; font-weight: bold;">&nbsp;Your FriendList</span></td>
        </tr>
        <tr>
            <td style="vertical-align: middle; width: 100%; height: 21px; text-align: center">
